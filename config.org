...
(after! which-key
  (require 'nerd-icons)
  (let ((evil-icon (nerd-icons-devicon "nf-dev-vim" :face '(:foreground "#a6e3a1" :weight 'bold) :v-adjust -0.1)))
    (pushnew!
...
(use-package! consult-yasnippet
  ...
  (setq consult-yasnippet-category-icon-alist
        `((t . ,(concat (nerd-icons-faicon "nf-fa-puzzle_piece" :face '(:foreground "#c6a0f6")) " »"))
          ("Emacs Lisp" . ,(concat (nerd-icons-devicon "nf-dev-emacs" :face '(:foreground "#c6a0f6")) " λ"))
          ("Text" . ,(concat (nerd-icons-faicon "nf-fa-text_height" :face '(:foreground "#cad3f5")) " ¶"))
...
(after! org
  ...
  (setq org-ellipsis ,(concat " " (nerd-icons-faicon "nf-fa-ellipsis_h" :face '(:foreground "#6e738d")) " "))
...
(after! org
  (require 'nerd-icons)
  (let* ((n-todo      (nerd-icons-octicon "nf-oct-issue_opened"      :face '(:foreground "#ed8796")))
         (n-next      (nerd-icons-mdicon "nf-mdi-ray_start_arrow"   :face '(:foreground "#f5a97f")))
         (n-prog      (nerd-icons-faicon "nf-fa-spinner"            :face '(:foreground "#8bd5ca")))
         (n-wait      (nerd-icons-mdicon "nf-mdi-timer_sand"        :face '(:foreground "#c6a0f6")))
         (n-done      (nerd-icons-octicon "nf-oct-issue_closed"     :face '(:foreground "#a6da95")))
         (n-cancelled (nerd-icons-octicon "nf-oct-skip"             :face '(:foreground "#6e738d")))
         (n-goal      (nerd-icons-mdicon "nf-mdi-target"            :face '(:foreground "#91d7e3")))
         (n-active    (nerd-icons-mdicon "nf-mdi-rocket_launch"     :face '(:foreground "#f5a97f")))
         (n-paused    (nerd-icons-mdicon "nf-mdi-pause_circle"      :face '(:foreground "#6e738d")))
         (n-achieved  (nerd-icons-mdicon "nf-mdi-trophy"            :face '(:foreground "#7dc4e4")))
         (n-dropped   (nerd-icons-mdicon "nf-mdi-cancel"            :face '(:foreground "#6e738d"))))
...
(after! org-modern
  ...
  (setq org-modern-star '("◉" "○" "◈" "◇" "◆" "▷")
        ...
        org-modern-list `((43 . ,(concat (nerd-icons-faicon "nf-fa-plus" :face '(:foreground "#89b4fa")) " ➤"))
                          (45 . ,(concat (nerd-icons-faicon "nf-fa-minus" :face '(:foreground "#ed8796")) " –"))
                          (42 . ,(concat (nerd-icons-faicon "nf-fa-asterisk" :face '(:foreground "#f9e2af")) " •")))
        org-modern-table-vertical 1
        org-modern-table-horizontal 0.1
        org-modern-block-name `(("src" ,(concat (nerd-icons-faicon "nf-fa-code" :face '(:foreground "#89b4fa")) " »") "«")
                                ("example" ,(concat (nerd-icons-octicon "nf-oct-beaker" :face '(:foreground "#a6e3a1")) " »") "«")
                                ("quote" ,(concat (nerd-icons-faicon "nf-fa-quote_left" :face '(:foreground "#cba6f7")) " ❝") "❞"))
       org-modern-tag-faces
        `((:foreground "#cad3f5" :weight bold :box (:line-width (1 . -1) :color "#363a4f")))
        org-modern-checkbox `((todo . ,(concat (nerd-icons-faicon "nf-fa-square_o") " ☐"))
                              (done . ,(concat (nerd-icons-faicon "nf-fa-check_square_o" :face '(:foreground "#a6da95")) " ☑"))
                              (cancel . ,(concat (nerd-icons-faicon "nf-fa-minus_square_o" :face '(:foreground "#6e738d")) " ☒"))
                              (priority . ,(concat (nerd-icons-faicon "nf-fa-flag" :face '(:foreground "#ed8796")) " ⚑"))
                              (on . "◉")
                              (off . "○"))))
  ...
  (let ((org-capture-templates
    ...
    (if keys
      ...
      (org-mks org-capture-templates
               ...
               "Template key: "
               `(("q" ,(concat (nerd-icons-octicon "nf-oct-stop" :face '(:foreground "#ed8796") :v-adjust 0.01) "\tAbort")))))))
         ...
         `(;; Main Capture Options
           ("Task" :keys "t"
            ...
            :template ("* ☛ TODO %?"
                       ...
                       "  :END:"))
           ("Note" :keys "n"
            ;; CORRECTED ICON: Replaced nf-mdi-note_text_outline with nf-mdi-note
            :icon ("nf-mdi-note" :set "mdicon" :color "#f9e2af")
            :file "inbox.org"
            :headline "Notes"
            :template ("* %? :note:"
                       "  :PROPERTIES:"
                       ...
                       "  :END:"))
           ("Journal" :keys "j"
            :icon ("nf-mdi-calendar_text" :set "mdicon" :color "#f5c2e7")
            :file "journal.org"
            :datetree t
            :template ("* %U %?"))
           ("Meeting" :keys "m"
            :icon ("nf-mdi-account_multiple" :set "mdicon" :color "#89b4fa")
            :file "inbox.org"
            :headline "Meetings"
           ...
           ;; Long-term Planning
           ("Project" :keys "p"
            :icon ("nf-mdi-rocket_launch" :set "mdicon" :color "#a6e3a1")
            :file "projects.org"
            :headline "Projects"
            :template ("* 🚀 ACTIVE %? :project:"
                       ...
                       "** 📝 Notes"))
           ("Book" :keys "b"
            :icon ("nf-mdi-book_open_page_variant" :set "mdicon" :color "#fab387")
            :file "reading.org"
            ...
            :template ("* ☛ TODO %? :book:read:"
                       ...
                       "** Quotes"))
           ("Goal" :keys "g"
            :icon ("nf-mdi-flag_checkered" :set "mdicon" :color "#cba6f7")
            :file "goals.org"
            :headline "Goals"
            :template ("* 🎯 GOAL %? :goal:"
           ...
           ;; Protocol links
           ("Protocol" :keys "P"
            :icon ("nf-mdi-link_variant" :set "mdicon" :color "#89b4fa")
            :file "Notes.org"
            :template ("* ☛ TODO %^{Title}"
                       "Source: %u"
                       "#+BEGIN_QUOTE"
           ...
           ("Protocol link" :keys "L"
            :icon ("nf-mdi-link_variant_plus" :set "mdicon" :color "#89b4fa")
            :file "Notes.org"
            :template ("* ☛ TODO %?"
                       "[[%:link][%:description]]"
                       "Captured on: %U"))))))#+end_src
